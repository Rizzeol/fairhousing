...
exports.stealth_memo_data = exports.signed_transaction = exports.transaction = exports.renewal_of_subscription = exports.finish_buying = exports.pay_seeder = exports.return_escrow_buying = exports.return_escrow_submission = exports.disallow_automatic_renewal_of_subscription = exports.content_cancellation = exports.set_publishing_right = exports.set_publishing_manager = exports.report_stats = exports.automatic_renewal_of_subscription = exports.subscribe_by_author = exports.subscribe = exports.deliver_keys = exports.DeliveryProofString = exports.proof_of_custody = exports.CustodyProof = exports.ready_to_publish2 = exports.ready_to_publish = exports.leave_rating_and_comment = exports.request_to_buy = exports.content_submit = undefined;
exports.CustodyData = exports.CiphertextString = exports.DIntegerString = exports.regional_price = exports.assert = exports.block_id_predicate = exports.asset_symbol_eq_lit_predicate = exports.account_name_eq_lit_predicate = exports.custom = exports.vesting_balance_withdraw = exports.vesting_balance_create = exports.cdd_vesting_policy_initializer = exports.linear_vesting_policy_initializer = exports.withdraw_permission_delete = exports.withdraw_permission_claim = exports.withdraw_permission_update = exports.withdraw_permission_create = exports.proposal_delete = exports.proposal_update = exports.proposal_create = exports.op_wrapper = exports.miner_update_global_parameters = exports.chain_parameters = exports.miner_update = exports.miner_create = exports.asset_publish_feed = exports.price_feed = exports.asset_claim_fees_operation = exports.asset_reserve_operation = exports.asset_issue = exports.update_monitored_asset_operation = exports.asset_fund_pools_operation = exports.update_user_issued_asset = exports.asset_create = exports.monitored_asset_options = exports.asset_options = exports.asset_extension = exports.account_update = exports.coreExchangeRate = exports.price = exports.account_create = exports.account_options = exports.authority = exports.transfer2 = exports.transfer = exports.memo_data = exports.signed_block_header = exports.block_header = exports.signed_block = exports.processed_transaction = exports.asset = exports.void_result = exports.fee_schedule = exports.renewal_of_subscription_operation_fee_parameters = exports.finish_buying_operation_fee_parameters = exports.pay_seeder_operation_fee_parameters = exports.return_escrow_buying_operation_fee_parameters = exports.return_escrow_submission_operation_fee_parameters = exports.disallow_automatic_renewal_of_subscription_operation_fee_parameters = exports.transfer2_operation_fee_parameters = exports.ready_to_publish2_operation_fee_parameters = exports.update_monitored_asset_operation_fee_parameters = exports.update_user_issued_asset_operation_fee_parameters = exports.asset_claim_fees_operation_fee_parameters = exports.asset_reserve_operation_fee_parameters = exports.asset_fund_pools_operation_fee_parameters = exports.content_cancellation_operation_fee_parameters = exports.set_publishing_right_operation_fee_parameters = exports.set_publishing_manager_operation_fee_parameters = exports.report_stats_operation_fee_parameters = exports.automatic_renewal_of_subscription_operation_fee_parameters = exports.subscribe_by_author_operation_fee_parameters = exports.subscribe_operation_fee_parameters = exports.deliver_keys_operation_fee_parameters = exports.proof_of_custody_operation_fee_parameters = exports.ready_to_publish_operation_fee_parameters = exports.leave_rating_and_comment_operation_fee_parameters = exports.request_to_buy_operation_fee_parameters = exports.content_submit_operation_fee_parameters = exports.assert_operation_fee_parameters = exports.custom_operation_fee_parameters = exports.vesting_balance_withdraw_operation_fee_parameters = exports.vesting_balance_create_operation_fee_parameters = exports.withdraw_permission_delete_operation_fee_parameters = exports.withdraw_permission_claim_operation_fee_parameters = exports.withdraw_permission_update_operation_fee_parameters = exports.withdraw_permission_create_operation_fee_parameters = exports.proposal_delete_operation_fee_parameters = exports.proposal_update_operation_fee_parameters = exports.proposal_create_operation_fee_parameters = exports.miner_update_global_parameters_operation_fee_parameters = exports.miner_update_operation_fee_parameters = exports.miner_create_operation_fee_parameters = exports.asset_publish_feed_operation_fee_parameters = exports.asset_update_operation_fee_parameters = exports.asset_create_operation_fee_parameters = exports.account_update_operation_fee_parameters = exports.account_create_operation_fee_parameters = exports.transfer_operation_fee_parameters = exports.operation = undefined;
...
var miner_create_operation_fee_parameters = exports.miner_create_operation_fee_parameters = new Serializer("miner_create_operation_fee_parameters", { fee: uint64 });

var miner_update_operation_fee_parameters = exports.miner_update_operation_fee_parameters = new Serializer("miner_update_operation_fee_parameters", { fee: int64 });

var miner_update_global_parameters_operation_fee_parameters = exports.miner_update_global_parameters_operation_fee_parameters = new Serializer("miner_update_global_parameters_operation_fee_parameters", { fee: uint64 });
...
var asset_fund_pools_operation_fee_parameters = exports.asset_fund_pools_operation_fee_parameters = new Serializer("asset_fund_pools_operation_fee_parameters", { fee: uint64 });
...
var update_user_issued_asset_operation_fee_parameters = exports.update_user_issued_asset_operation_fee_parameters = new Serializer("update_user_issued_asset_operation_fee_parameters", { fee: uint64 });

var update_monitored_asset_operation_fee_parameters = exports.update_monitored_asset_operation_fee_parameters = new Serializer("update_monitored_asset_operation_fee_parameters", { fee: uint64 });

var ready_to_publish2_operation_fee_parameters = exports.ready_to_publish2_operation_fee_parameters = new Serializer("ready_to_publish2_operation_fee_parameters", { fee: uint64 });

var transfer2_operation_fee_parameters = exports.transfer2_operation_fee_parameters = new Serializer("transfer2_operation_fee_parameters", { fee: uint64 });
...
var coreExchangeRate = exports.coreExchangeRate = new Serializer("core_exchange_rate", {
...
var asset_extension = exports.asset_extension = new Serializer("asset_extension", {
...
var monitored_asset_options = exports.monitored_asset_options = new Serializer("monitored_asset_options", {
...
var update_user_issued_asset = exports.update_user_issued_asset = new Serializer("update_user_issued_asset", {
    fee: asset,
    issuer: protocol_id_type("account"),
...
var asset_fund_pools_operation = exports.asset_fund_pools_operation = new Serializer("asset_fund_pools_operation", {
    fee: asset,
...
var update_monitored_asset_operation = exports.update_monitored_asset_operation = new Serializer("update_monitored_asset_operation", {
    fee: asset,
    issuer: protocol_id_type("account"),
    asset_to_update: protocol_id_type("asset"),
    new_description: string,
...
var asset_reserve_operation = exports.asset_reserve_operation = new Serializer("asset_reserve_operation", {
    fee: asset,
...
var asset_claim_fees_operation = exports.asset_claim_fees_operation = new Serializer("asset_claim_fees_operation", {
    fee: asset,
    issuer: protocol_id_type("account"),
    uia_asset: asset,
    dct_asset: asset,
...
var miner_create = exports.miner_create = new Serializer("miner_create", {
    fee: asset,
...
var miner_update = exports.miner_update = new Serializer("miner_update", {
    fee: asset,
...
var miner_update_global_parameters = exports.miner_update_global_parameters = new Serializer("miner_update_global_parameters", {
    fee: asset,
...
var ready_to_publish2 = exports.ready_to_publish2 = new Serializer("ready_to_publish2", {
    fee: asset,
    seeder: protocol_id_type("account"),
    space: uint64,
    pubKey: DIntegerString,
...
operation.st_operations = [transfer, account_create, account_update, asset_create, asset_issue, asset_publish_feed, // 5
miner_create, miner_update, miner_update_global_parameters, proposal_create, proposal_update, // 10
proposal_delete, withdraw_permission_create, withdraw_permission_update, withdraw_permission_claim, withdraw_permission_delete, // 15
vesting_balance_create, vesting_balance_withdraw, custom, assert, content_submit, // 20
request_to_buy, leave_rating_and_comment, ready_to_publish, proof_of_custody, deliver_keys, // 25
subscribe, subscribe_by_author, automatic_renewal_of_subscription, report_stats, set_publishing_manager, // 30
set_publishing_right, content_cancellation, asset_fund_pools_operation, asset_reserve_operation, asset_claim_fees_operation, // 35
update_user_issued_asset, update_monitored_asset_operation, ready_to_publish2, transfer2, disallow_automatic_renewal_of_subscription, // 40
return_escrow_submission, return_escrow_buying, pay_seeder, finish_buying, renewal_of_subscription];
